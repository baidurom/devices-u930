...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 176
    iput-boolean v11, p0, Landroid/media/AudioService;->mHeadseton:Z
    ...
    .line 464
    iget v0, p0, Landroid/media/AudioService;->mDualmicStatus:I
    ...
    .line 473
    :goto_1
    iget v0, p0, Landroid/media/AudioService;->mSRSStatus:I

    if-nez v0, :cond_3

    .line 474
    const-string v0, "SRS_setting=0"
    ...
    iget v1, p0, Landroid/media/AudioService;->mSRSStatus:I

    if-ne v0, v1, :cond_6

    .line 483
    const-string v0, "SRS_setting=4"
...
.method private getActiveStreamType(I)I
    ...
    invoke-virtual {p0}, Landroid/media/AudioService;->isBroadcomFMActive()Z
...
.method private handleDeviceConnection(ZILjava/lang/String;)Z
    ...
    invoke-virtual {p0, v1}, Landroid/media/AudioService;->adjustVolumeWhenPlug(I)V
...
.method private readPersistedSettings()V
    ...
    .line 676
    const-string v4, "dualmic"

    invoke-static {v0, v4, v7}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v4

    iput v4, p0, Landroid/media/AudioService;->mDualmicStatus:I

    .line 677
    const-string/jumbo v4, "srs_mode"

    invoke-static {v0, v4, v7}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v4

    iput v4, p0, Landroid/media/AudioService;->mSRSStatus:I

    .line 678
    const-string v4, "AudioService"

    const-string v5, "get dualmic and SRS."
...
.method public adjustStreamVolume(III)V
    ...
    .line 761
    .local v20, aliasIndex:I
    const/16 v19, 0x1

    .line 764
    .local v19, adjustVolume:Z
    const/16 v5, 0xa
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/AudioService;->isBroadcomFMActive()Z
    ...
    const-string v6, "liying, adjustStreamVolume STREAM_FM == true , ACTION_SETFMVOL"

    invoke-static {v5, v6}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 821
    const-string v18, "com.broadcom.bt.app.fm.ACTION_SETFMVOL"

    .line 822
    .local v18, ACTION_SETFMVOL:Ljava/lang/String;
    ...
    .line 827
    .end local v18           #ACTION_SETFMVOL:Ljava/lang/String;
    ...
    .line 759
    .end local v19           #adjustVolume:Z
    .end local v20           #aliasIndex:I
    ...
    .line 786
    .restart local v19       #adjustVolume:Z
    .restart local v20       #aliasIndex:I
...
.method public adjustVolumeWhenPlug(I)V
    .locals 7
    .parameter "stream"
    ...
    invoke-virtual {v5, v6}, Landroid/media/AudioService$VolumeStreamState;->applyDeviceVolume(I)V
...
.method public isBroadcomFMActive()Z
    .locals 5
...
.method public setStreamVolume(III)V
    ...
    :goto_0
    invoke-virtual {v10, v3, v0}, Landroid/media/AudioService$VolumeStreamState;->getIndex(IZ)I
    ...
    .line 895
    :goto_2
    invoke-virtual {p0, v8}, Landroid/media/AudioService;->setRingerMode(I)V

    .line 898
    .end local v8           #newRingerMode:I
    :cond_1
    const/4 v0, 0x3
    ...
    const-string v1, "liying, setStreamVolume STREAM_FM == true , ACTION_SETFMVOL"

    invoke-static {v0, v1}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 901
    const-string v6, "com.broadcom.bt.app.fm.ACTION_SETFMVOL"

    .line 902
    .local v6, ACTION_SETFMVOL:Ljava/lang/String;
    ...
    .line 907
    .end local v6           #ACTION_SETFMVOL:Ljava/lang/String;
    ...
    .line 912
    invoke-direct {p0, p1, v9, p2, p3}, Landroid/media/AudioService;->sendVolumeUpdate(IIII)V
    ...
    .restart local v8       #newRingerMode:I
    goto :goto_2
