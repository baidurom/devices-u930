...
.method private handleActionMove(Landroid/view/MotionEvent;)V
    ...
    .line 682
    .local v21, patternSizePreHitDetect:I
    move-object/from16 v0, p0
    ...
    .line 683
    .local v10, hitCell:Lcom/android/internal/widget/LockPatternView$Cell;
    move-object/from16 v0, p0
    ...
    iget-object v12, v0, Lcom/android/internal/widget/LockPatternView;->mInvalidate:Landroid/graphics/Rect;

    .line 714
    .local v12, invalidateRect:Landroid/graphics/Rect;
    cmpg-float v33, v24, v31
    ...
    .line 756
    iget v0, v10, Lcom/android/internal/widget/LockPatternView$Cell;->column:I
    ...
    .line 757
    iget v0, v10, Lcom/android/internal/widget/LockPatternView$Cell;->row:I
    ...
    .end local v10           #hitCell:Lcom/android/internal/widget/LockPatternView$Cell;
    check-cast v10, Lcom/android/internal/widget/LockPatternView$Cell;

    .line 762
    .restart local v10       #hitCell:Lcom/android/internal/widget/LockPatternView$Cell;
    iget v0, v10, Lcom/android/internal/widget/LockPatternView$Cell;->column:I
    ...
    .line 796
    .local v14, lastCell0:Lcom/android/internal/widget/LockPatternView$Cell;
    ...
    div-float v30, v33, v34

    .line 799
    .local v30, widthOffset0:F
    move-object/from16 v0, p0
    ...
    .line 800
    .local v8, heightOffset0:F
    sub-float v33, v25, v30
    ...
    invoke-virtual {v0, v12}, Lcom/android/internal/widget/LockPatternView;->invalidate(Landroid/graphics/Rect;)V

    .line 678
    .end local v4           #bottom:F
    .end local v8           #heightOffset0:F
    .end local v12           #invalidateRect:Landroid/graphics/Rect;
    .end local v13           #lastCell:Lcom/android/internal/widget/LockPatternView$Cell;
    .end local v14           #lastCell0:Lcom/android/internal/widget/LockPatternView$Cell;
    .end local v15           #left:F
    .end local v16           #oldX:F
    .end local v17           #oldY:F
    .end local v18           #pattern:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/widget/LockPatternView$Cell;>;"
    .end local v20           #patternSize0:I
    .end local v22           #radius:F
    .end local v23           #right:F
    .end local v24           #startX:F
    .end local v25           #startX0:F
    .end local v26           #startY:F
    .end local v27           #startY0:F
    .end local v28           #top:F
    .end local v30           #widthOffset0:F
    :cond_2
    :goto_9
    ...
    .end local v21           #patternSizePreHitDetect:I
    .end local v31           #x:F
    .end local v32           #y:F
    :cond_3
    ...
    .restart local v10       #hitCell:Lcom/android/internal/widget/LockPatternView$Cell;
    .restart local v12       #invalidateRect:Landroid/graphics/Rect;
    .restart local v13       #lastCell:Lcom/android/internal/widget/LockPatternView$Cell;
    .restart local v16       #oldX:F
    .restart local v17       #oldY:F
    .restart local v18       #pattern:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/widget/LockPatternView$Cell;>;"
    .restart local v19       #patternSize:I
    .restart local v21       #patternSizePreHitDetect:I
    .restart local v22       #radius:F
    .restart local v24       #startX:F
    .restart local v26       #startY:F
